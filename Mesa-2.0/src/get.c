/* $Id: get.c,v 1.2 1996/09/15 14:17:30 brianp Exp $ */
...
void gl_GetBooleanv( GLcontext *ctx, GLenum pname, GLboolean *params )
{
   ...
   switch (pname) {
	 ...
	 *params = ENUM_TO_BOOL( ctx->ExecuteFlag
	 ...
	 break;
      case GL_LOGIC_OP:
	 *params = ctx->Color.LogicOpEnabled;
	 break;
...
void gl_GetDoublev( GLcontext *ctx, GLenum pname, GLdouble *params )
{
   ...
   switch (pname) {
	 ...
	 *params = ctx->ExecuteFlag ? (GLdouble) GL_COMPILE_AND_EXECUTE
	 ...
	 break;
      case GL_LOGIC_OP:
	 *params = (GLdouble) ctx->Color.LogicOpEnabled;
	 break;
      case GL_LOGIC_OP_MODE:
...
void gl_GetFloatv( GLcontext *ctx, GLenum pname, GLfloat *params )
{
   ...
   switch (pname) {
	 ...
	 *params = ctx->ExecuteFlag ? (GLfloat) GL_COMPILE_AND_EXECUTE
	 ...
	 break;
      case GL_LOGIC_OP:
	 *params = (GLfloat) ctx->Color.LogicOpEnabled;
	 break;
      case GL_LOGIC_OP_MODE:
...
void gl_GetIntegerv( GLcontext *ctx, GLenum pname, GLint *params )
{
   ...
   switch (pname) {
	 ...
	 *params = ctx->ExecuteFlag ? (GLint) GL_COMPILE_AND_EXECUTE
	 ...
	 break;
      case GL_LOGIC_OP:
	 *params = (GLint) ctx->Color.LogicOpEnabled;
	 break;
      case GL_LOGIC_OP_MODE:
