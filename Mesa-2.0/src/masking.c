/* $Id: masking.c,v 1.1 1996/09/13 01:38:16 brianp Exp $ */
                         ...
                         GLubyte blue[], GLubyte alpha[] )
{
   ...
   (*ctx->Driver.ReadColorSpan)( ctx, n, x, y, r, g, b, a );
   if (ctx->RasterMask & ALPHABUF_BIT) {
      gl_read_alpha_span( ctx, n, x, y, a );
   }
                         ...
                         GLuint n, GLint x, GLint y, GLuint index[] )
{
   ...
   (*ctx->Driver.ReadIndexSpan)( ctx, n, x, y, fbindexes );
