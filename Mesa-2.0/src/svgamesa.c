/* $Id: svgamesa.c,v 1.1 1996/09/13 01:38:16 brianp Exp $ */
...
struct svgamesa_context {
   struct gl_context *gl_ctx;	/* the core Mesa context */
...
static void svgamesa_setup_DD_pointers( GLcontext *ctx )
{
   ...
   ctx->Driver.update_state = svgamesa_setup_DD_pointers;

   ctx->Driver.clear_index = clear_index;
   ctx->Driver.clear_color = clear_color;
   ctx->Driver.clear = clear;

   ctx->Driver.index = set_index;
   ctx->Driver.color = set_color;

   ctx->Driver.set_buffer = set_buffer;
   ctx->Driver.GetBufferSize = get_buffer_size;

   ctx->Driver.PointsFunc = NULL;
   ctx->Driver.LineFunc = NULL;
   ctx->Driver.PolygonFunc = NULL;

   /* Pixel/span writing functions: */
   /* TODO: use different funcs for 8, 16, 32-bit depths */
   ctx->Driver.write_color_span       = write_color_span;
   ctx->Driver.write_monocolor_span   = write_monocolor_span;
   ctx->Driver.write_color_pixels     = write_color_pixels;
   ctx->Driver.write_monocolor_pixels = write_monocolor_pixels;
   ctx->Driver.write_index_span       = write_index_span;
   ctx->Driver.write_monoindex_span   = write_monoindex_span;
   ctx->Driver.write_index_pixels     = write_index_pixels;
   ctx->Driver.write_monoindex_pixels = write_monoindex_pixels;

   /* Pixel/span reading functions: */
   /* TODO: use different funcs for 8, 16, 32-bit depths */
   ctx->Driver.read_index_span = read_index_span;
   ctx->Driver.read_color_span = read_color_span;
   ctx->Driver.read_index_pixels = read_index_pixels;
   ctx->Driver.read_color_pixels = read_color_pixels;
}
...
SVGAMesaContext SVGAMesaCreateContext( void )
{
   ...
   ctx->gl_ctx = gl_create_context( rgb_flag,
                                    alpha_flag,
                                    db_flag,
                                    16,   /* depth_size */
                                    8,    /* stencil_size */
